...
while (continuar != `FIN`) {
    let ok = prompt(`Hola! Bienvenido al SDM (Sistema de División Monetaria). Escriba “OK” para continuar.`).toUpperCase();
    if (ok != `OK`) {
        alert(`ERROR. ${enter}`);
    } else {
            ...
            if (total <= 0) {
                ...
                // (For de ingresos por cada amigo.)
                    switch(i) {
                        ...
                        case 1:
                            nombre1 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal1 = parseFloat(prompt(`¿Cuánto pagó ${nombre1}?`));
                        ...
                        break;
                        case 2:
                            nombre2 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal2 = parseFloat(prompt(`¿Cuánto pagó ${nombre2}?`));
                        ...
                        break;
                        case 3:
                            nombre3 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal3 = parseFloat(prompt(`¿Cuánto pagó ${nombre3}?`));
                        ...
                        break;
                        case 4:
                            nombre4 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal4 = parseFloat(prompt(`¿Cuánto pagó ${nombre4}?`));
                        ...
                        break;
                        case 5:
                            nombre5 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal5 = parseFloat(prompt(`¿Cuánto pagó ${nombre5}?`));
                        ...
                        break;
                        case 6:
                            nombre6 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal6 = parseFloat(prompt(`¿Cuánto pagó ${nombre6}?`));
                        ...
                        break;
                        case 7:
                            nombre7 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal7 = parseFloat(prompt(`¿Cuánto pagó ${nombre7}?`));
                        ...
                        break;
                        case 8:
                            nombre8 = prompt(`¿Quién es el amigo N°${i}?`);
                            pagoReal8 = parseFloat(prompt(`¿Cuánto pagó ${nombre8}?`));
                ...
                if (total != totalReal){
                    ...
                    for (let j = 1; j <= cantAmigos; j++) {
                        ...
                        // (A diferencia del switch anterior, en este caso si podría haber hecho una función por cada case, sin embargo, habrían quedado más de 30 variables, entonces tomé la decisión de dividir entre ifAcreedor e IfSegundosCases.)
                    }
